...
#SBATCH --job-name analyzer-cnf-01-matt
...
# Create an output file that will be analyzer-output-<jobid>.out

#SBATCH -o analyzer-output-%j.out

# Create an error file that will be analyzer-error-<jobid>.out

#SBATCH -e analyzer-error-%j.err
